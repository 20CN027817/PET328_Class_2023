...
print('The hydrocarbon pseudo-critical pressure is {0:.1f} psia'.format(p_pc))
print('The hydrocarbon pseudo-critical temperature is {0:.1f} deg Rankine'.format(t_pc))
